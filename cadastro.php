<?php
    ...
    if ($_REQUEST) {
        ...
        // verifica se a senha for = a confirmar senha, caso positivo cria um novo $novoUsuario
    if ($senha == $confirmarSenha){
        ...
        // cadastrando um novo usuário no .json utilizando a funcao criado previamente no funcoesLogin.php   
...
?>
    ...
    <div class="page-center">
        <h2>Cadastre-se</h2>  
        <!-- verifica se a variavel cadastrou está definida e se ela é true -->
